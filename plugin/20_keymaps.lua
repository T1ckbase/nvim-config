...
vim.keymap.set('n', 'K', function()
  vim.lsp.buf.hover({ max_width = 100, max_height = 20, border = 'solid' })
end, { desc = 'vim.lsp.buf.hover()' })
vim.keymap.set('n', '<leader>ld', function()
  vim.diagnostic.open_float(nil, { focusable = true, border = 'solid' })
...
vim.keymap.set('n', '<leader>ff', function()
  MiniPick.registry.files({ hidden = true })
end, { desc = 'Find files' })
vim.keymap.set('n', '<leader>fF', function()
  MiniPick.registry.files({ hidden = true, ignored = true })
...
vim.keymap.set('n', '<leader>fw', function()
  MiniPick.registry.grep_live({ hidden = true })
end, { desc = 'Find words' })
vim.keymap.set('n', '<leader>fW', function()
  MiniPick.registry.grep_live({ hidden = true, ignored = true })
